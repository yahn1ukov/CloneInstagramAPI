...
{
    public class UpdatePostUnsetLikeUserByIdCommandHandler : IRequestHandler<UpdatePostSetLikeUserByIdCommand, bool>
    {
        private readonly IUserRepository _userRepository;
        private readonly IPostRepository _postRepository;

        public UpdatePostUnsetLikeUserByIdCommandHandler
        (
