...
{
    public class GetAllPostsSavesUserByUsernameQueryHandler : IRequestHandler<GetAllPostsSavesUserByUsernameQuery, IEnumerable<GetAllPostsResult>>
    {
        ...
        public async Task<IEnumerable<GetAllPostsResult>> Handle(GetAllPostsSavesUserByUsernameQuery query, CancellationToken cancellationToken)
        {
